...
public class RequestCapture {
    private static final int MAX_CACHE_LIMIT = 1024 * 1024; // 1 MB limit
    ...
    {
        ContentCachingRequestWrapper request = new ContentCachingRequestWrapper(requestx,MAX_CACHE_LIMIT);
        return processingData(request);
    }
